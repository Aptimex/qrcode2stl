export default {
  ...
  faqQuestion6: 'Wie kann ich mehrere QR-Codes gleichzeitig generieren?',
  faqAnswer6: 'Nutze die Stapelverarbeitungsfunktion! Klicke auf den "Stapelverarbeitung"-Button im QR-Code-Optionen-Bereich. Konfiguriere zuerst deine Standardeinstellungen im Hauptformular. Lade dann die CSV-Vorlage herunter, fülle sie mit deinen Daten (ein QR-Code pro Zeile) und lade sie hoch. Das Tool generiert alle QR-Codes und verpackt sie in einer ZIP-Datei zum Download. Du kannst jeden QR-Code anpassen, indem du die entsprechende Spalte ausfüllst, oder Zellen leer lassen, um deine Standardeinstellungen zu verwenden. Fahre mit der Maus über ein Label im Hauptformular, um den Feldnamen für die CSV zu sehen.',
  ...
  // Batch Mode
  //
  batchMode: 'Stapelverarbeitung',
  batchModeDescription: 'Generiere mehrere QR-Codes aus einer CSV-Datei. Jede Zeile in der CSV erstellt eine separate STL-Datei.',
  batchHowToTitle: 'So verwendest du die Stapelverarbeitung:',
  batchStep1: 'Konfiguriere zuerst deine QR-Code-Einstellungen im Hauptformular (Inhaltstyp, Modelloptionen, etc.). Diese werden als Standardwerte verwendet.',
  batchStep2: 'Lade die CSV-Vorlage unten herunter. Sie enthält alle verfügbaren Felder für den ausgewählten Inhaltstyp.',
  batchStep3: 'Fülle die CSV mit deinen Daten. Jede Zeile wird zu einem QR-Code. Lasse Zellen leer, um deine Standardeinstellungen zu verwenden.',
  batchStep4: 'Lade die CSV-Datei hoch und klicke auf "Alle generieren", um deine QR-Codes als ZIP-Archiv zu erstellen.',
  batchTips: 'Tipps:',
  batchTip1: 'Fahre mit der Maus über ein Label im Hauptformular, um den Feldnamen zu sehen (z.B. "base.width", "code.depth").',
  batchTip2: 'Füge eine "filename"-Spalte hinzu, um die Ausgabedateinamen anzupassen (ohne .stl-Erweiterung).',
  batchTip3: 'Die CSV kann entweder Komma (,) oder Semikolon (;) als Trennzeichen verwenden.',
  batchTemplateDownload: 'Schritt 1: CSV-Vorlage herunterladen',
  batchTemplateHelp: 'Lade eine CSV-Vorlagendatei mit allen verfügbaren Feldern für den aktuell ausgewählten Inhaltstyp herunter. Die Vorlage enthält eine Beispielzeile mit deinen aktuellen Einstellungen.',
  downloadCsvTemplate: 'Vorlage herunterladen',
  uploadCsvFile: 'Schritt 2: CSV-Datei hochladen',
  chooseFile: 'Datei auswählen...',
  noFileSelected: 'Keine Datei ausgewählt',
  batchLargeWarning: 'Du bist dabei, {count} QR-Codes zu generieren. Dies kann eine Weile dauern und viel Speicher verwenden. Erwäge, in kleinere Stapel aufzuteilen, wenn Probleme auftreten.',
  batchPreview: 'Vorschau',
  batchShowingRows: 'zeige {shown} von {total} Zeilen',
  batchMoreRows: '...und {count} weitere Zeilen',
  batchValidation: 'Validierung',
  batchValidRows: 'Gültige Zeilen',
  batchInvalidRows: 'Ungültige Zeilen (werden übersprungen)',
  batchProcessing: 'Generiere QR-Codes...',
  batchProgress: 'Verarbeite {current} von {total}',
  batchCurrentItem: 'Aktuell',
  batchGenerate: 'Alle generieren',
  batchAbort: 'Abbrechen',
  batchDownloadZip: 'ZIP herunterladen',
  batchStartNew: 'Neuen Stapel starten',
  batchSuccessCount: '{count} QR-Code(s) erfolgreich generiert!',
  batchErrorCount: '{count} QR-Code(s) konnten nicht generiert werden',
  batchRowError: 'Zeile {row}: {error}',
  batchMoreErrors: '...und {count} weitere Fehler',
  batchParseError: 'Fehler beim Parsen der CSV',
  batchFileReadError: 'Fehler beim Lesen der Datei',
  batchNoDataRows: 'Die CSV-Datei muss mindestens eine Kopfzeile und eine Datenzeile enthalten',
  batchMissingRequiredField: 'CSV muss mindestens eine dieser Spalten enthalten: {fields}',
  batchEmptyQRText: 'Leerer QR-Code-Inhalt',
  cancel: 'Abbrechen',
  close: 'Schließen',
  or: 'oder',
